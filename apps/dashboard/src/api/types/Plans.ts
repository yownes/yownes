...
export interface Plans_features_edges_node {
...
export interface Plans_features_edges {
  __typename: "FeaturesTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: Plans_features_edges_node | null;
}
...
export interface Plans_features {
   ...
   */
  edges: (Plans_features_edges | null)[];
}

export interface Plans_products_edges_node_features_edges_node {
  __typename: "FeaturesType";
  /**
   * The ID of the object.
   */
...
export interface Plans_products_edges_node_features_edges {
  __typename: "FeaturesTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: Plans_products_edges_node_features_edges_node | null;
}
...
export interface Plans_products_edges_node_features {
   ...
   * Contains the nodes in this connection.
   */
  edges: (Plans_products_edges_node_features_edges | null)[];
}
