...
export interface Invoices_invoices_edges_node_subscription_plan_product {
...
export interface Invoices_invoices_edges_node_subscription_plan {
  __typename: "StripePlanType";
  /**
   * The product whose pricing this plan determines.
   */
  product: Invoices_invoices_edges_node_subscription_plan_product | null;
}
...
export interface Invoices_invoices_edges_node_subscription {
   ...
   */
  plan: Invoices_invoices_edges_node_subscription_plan | null;
  /**
