...
// ====================================================
// GraphQL fragment: SubscriptionBasicData
// ====================================================

export interface SubscriptionBasicData_customer {
...
export interface SubscriptionBasicData_invoices_edges_node_charges_edges_node_paymentIntent {
...
export interface SubscriptionBasicData_invoices_edges_node_charges_edges_node_paymentMethod {
...
export interface SubscriptionBasicData_invoices_edges_node_charges_edges_node {
   ...
   */
  paymentIntent: SubscriptionBasicData_invoices_edges_node_charges_edges_node_paymentIntent | null;
  /**
   * PaymentMethod used in this charge.
   */
  paymentMethod: SubscriptionBasicData_invoices_edges_node_charges_edges_node_paymentMethod | null;
  /**
...
export interface SubscriptionBasicData_invoices_edges_node_charges_edges {
  __typename: "StripeChargeTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: SubscriptionBasicData_invoices_edges_node_charges_edges_node | null;
}

export interface SubscriptionBasicData_invoices_edges_node_charges {
  __typename: "StripeChargeTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (SubscriptionBasicData_invoices_edges_node_charges_edges | null)[];
}

export interface SubscriptionBasicData_invoices_edges_node_customer {
  __typename: "StripeCustomerType";
  /**
   * The ID of the object.
   */
...
export interface SubscriptionBasicData_invoices_edges_node_invoiceitems_edges_node_price {
...
export interface SubscriptionBasicData_invoices_edges_node_invoiceitems_edges_node {
   ...
   */
  price: SubscriptionBasicData_invoices_edges_node_invoiceitems_edges_node_price | null;
  /**
...
export interface SubscriptionBasicData_invoices_edges_node_invoiceitems_edges {
  __typename: "StripeInvoiceItemTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: SubscriptionBasicData_invoices_edges_node_invoiceitems_edges_node | null;
}

export interface SubscriptionBasicData_invoices_edges_node_invoiceitems {
  __typename: "StripeInvoiceItemTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (SubscriptionBasicData_invoices_edges_node_invoiceitems_edges | null)[];
}

export interface SubscriptionBasicData_invoices_edges_node_paymentIntent_paymentMethod {
  __typename: "StripePaymentMethodType";
  /**
   * The ID of the object.
   */
...
export interface SubscriptionBasicData_invoices_edges_node {
   ...
   */
  charges: SubscriptionBasicData_invoices_edges_node_charges;
  /**
   * The datetime this object was created in stripe.
   */
  created: any | null;
   ...
   */
  customer: SubscriptionBasicData_invoices_edges_node_customer;
  /**
   ...
   */
  invoiceitems: SubscriptionBasicData_invoices_edges_node_invoiceitems;
  /**
   ...
   */
  paymentIntent: SubscriptionBasicData_invoices_edges_node_paymentIntent | null;
  /**
   ...
   */
  subscription: SubscriptionBasicData_invoices_edges_node_subscription | null;
  /**
...
export interface SubscriptionBasicData_invoices_edges {
  __typename: "StripeInvoiceTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: SubscriptionBasicData_invoices_edges_node | null;
}

export interface SubscriptionBasicData_invoices {
  __typename: "StripeInvoiceTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (SubscriptionBasicData_invoices_edges | null)[];
}

export interface SubscriptionBasicData {
  __typename: "StripeSubscriptionType";
  /**
   * The ID of the object.
   */
   ...
   */
  customer: SubscriptionBasicData_customer;
  /**
   ...
   * The subscription that this invoice was prepared for, if any.
   */
  invoices: SubscriptionBasicData_invoices;
  /**
   * The status of this subscription.
   */
  status: SubscriptionStatus;
