...
export interface UpdateSubscription_updateSubscription_subscription_customer {
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges_edges_node_paymentIntent {
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges_edges_node_paymentMethod {
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges_edges_node {
   ...
   */
  paymentIntent: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges_edges_node_paymentIntent | null;
  /**
   * PaymentMethod used in this charge.
   */
  paymentMethod: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges_edges_node_paymentMethod | null;
  /**
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges_edges {
  __typename: "StripeChargeTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges_edges_node | null;
}

export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges {
  __typename: "StripeChargeTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges_edges | null)[];
}

export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_customer {
  __typename: "StripeCustomerType";
  /**
   * The ID of the object.
   */
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_invoiceitems_edges_node_price {
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_invoiceitems_edges_node {
   ...
   */
  price: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_invoiceitems_edges_node_price | null;
  /**
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_invoiceitems_edges {
  __typename: "StripeInvoiceItemTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_invoiceitems_edges_node | null;
}

export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_invoiceitems {
  __typename: "StripeInvoiceItemTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (UpdateSubscription_updateSubscription_subscription_invoices_edges_node_invoiceitems_edges | null)[];
}

export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node_paymentIntent_paymentMethod {
  __typename: "StripePaymentMethodType";
  /**
   * The ID of the object.
   */
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges_node {
   ...
   */
  charges: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_charges;
  /**
   * The datetime this object was created in stripe.
   */
  created: any | null;
   ...
   */
  customer: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_customer;
  /**
   ...
   */
  invoiceitems: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_invoiceitems;
  /**
   ...
   */
  paymentIntent: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_paymentIntent | null;
  /**
   ...
   */
  subscription: UpdateSubscription_updateSubscription_subscription_invoices_edges_node_subscription | null;
  /**
...
export interface UpdateSubscription_updateSubscription_subscription_invoices_edges {
   ...
   * The item at the end of the edge
   */
  node: UpdateSubscription_updateSubscription_subscription_invoices_edges_node | null;
}

export interface UpdateSubscription_updateSubscription_subscription_invoices {
  __typename: "StripeInvoiceTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (UpdateSubscription_updateSubscription_subscription_invoices_edges | null)[];
}

export interface UpdateSubscription_updateSubscription_subscription {
  __typename: "StripeSubscriptionType";
  /**
   * The ID of the object.
   */
   ...
   */
  customer: UpdateSubscription_updateSubscription_subscription_customer;
  /**
   ...
   * The subscription that this invoice was prepared for, if any.
   */
  invoices: UpdateSubscription_updateSubscription_subscription_invoices;
  /**
   * The status of this subscription.
   */
  status: SubscriptionStatus;
...
export interface UpdateSubscription_updateSubscription {
  __typename: "UpdateSubscriptionMutation";
  ok: boolean | null;
  error: string | null;
  subscription: UpdateSubscription_updateSubscription_subscription | null;
