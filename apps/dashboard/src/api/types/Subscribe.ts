...
export interface Subscribe_subscribe_subscription_customer {
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_charges_edges_node_paymentIntent {
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_charges_edges_node_paymentMethod {
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_charges_edges_node {
   ...
   */
  paymentIntent: Subscribe_subscribe_subscription_invoices_edges_node_charges_edges_node_paymentIntent | null;
  /**
   * PaymentMethod used in this charge.
   */
  paymentMethod: Subscribe_subscribe_subscription_invoices_edges_node_charges_edges_node_paymentMethod | null;
  /**
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_charges_edges {
  __typename: "StripeChargeTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: Subscribe_subscribe_subscription_invoices_edges_node_charges_edges_node | null;
}

export interface Subscribe_subscribe_subscription_invoices_edges_node_charges {
  __typename: "StripeChargeTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (Subscribe_subscribe_subscription_invoices_edges_node_charges_edges | null)[];
}

export interface Subscribe_subscribe_subscription_invoices_edges_node_customer {
  __typename: "StripeCustomerType";
  /**
   * The ID of the object.
   */
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_invoiceitems_edges_node_price {
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_invoiceitems_edges_node {
   ...
   */
  price: Subscribe_subscribe_subscription_invoices_edges_node_invoiceitems_edges_node_price | null;
  /**
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_invoiceitems_edges {
  __typename: "StripeInvoiceItemTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: Subscribe_subscribe_subscription_invoices_edges_node_invoiceitems_edges_node | null;
}

export interface Subscribe_subscribe_subscription_invoices_edges_node_invoiceitems {
  __typename: "StripeInvoiceItemTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (Subscribe_subscribe_subscription_invoices_edges_node_invoiceitems_edges | null)[];
}

export interface Subscribe_subscribe_subscription_invoices_edges_node_paymentIntent_paymentMethod {
  __typename: "StripePaymentMethodType";
  /**
   * The ID of the object.
   */
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_paymentIntent {
  __typename: "StripePaymentIntentType";
  /**
   * The ID of the object.
   */
   ...
   */
  paymentMethod: Subscribe_subscribe_subscription_invoices_edges_node_paymentIntent_paymentMethod | null;
}

export interface Subscribe_subscribe_subscription_invoices_edges_node_subscription_plan_product {
...
export interface Subscribe_subscribe_subscription_invoices_edges_node_subscription_plan {
  __typename: "StripePlanType";
  /**
   * The product whose pricing this plan determines.
   */
  product: Subscribe_subscribe_subscription_invoices_edges_node_subscription_plan_product | null;
}

export interface Subscribe_subscribe_subscription_invoices_edges_node_subscription {
   ...
   */
  plan: Subscribe_subscribe_subscription_invoices_edges_node_subscription_plan | null;
  /**
...
export interface Subscribe_subscribe_subscription_invoices_edges_node {
   ...
   */
  charges: Subscribe_subscribe_subscription_invoices_edges_node_charges;
  /**
   * The datetime this object was created in stripe.
   */
  created: any | null;
   ...
   */
  customer: Subscribe_subscribe_subscription_invoices_edges_node_customer;
  /**
   ...
   */
  invoiceitems: Subscribe_subscribe_subscription_invoices_edges_node_invoiceitems;
  /**
   ...
   */
  paymentIntent: Subscribe_subscribe_subscription_invoices_edges_node_paymentIntent | null;
  /**
   ...
   */
  subscription: Subscribe_subscribe_subscription_invoices_edges_node_subscription | null;
  /**
...
export interface Subscribe_subscribe_subscription_invoices_edges {
  __typename: "StripeInvoiceTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: Subscribe_subscribe_subscription_invoices_edges_node | null;
}

export interface Subscribe_subscribe_subscription_invoices {
  __typename: "StripeInvoiceTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (Subscribe_subscribe_subscription_invoices_edges | null)[];
}

export interface Subscribe_subscribe_subscription {
  __typename: "StripeSubscriptionType";
  /**
   * The ID of the object.
   */
   ...
   */
  customer: Subscribe_subscribe_subscription_customer;
  /**
   ...
   * The subscription that this invoice was prepared for, if any.
   */
  invoices: Subscribe_subscribe_subscription_invoices;
  /**
   * The status of this subscription.
   */
  status: SubscriptionStatus;
...
export interface Subscribe_subscribe {
  ...
  ok: boolean | null;
  error: string | null;
  subscription: Subscribe_subscribe_subscription | null;
