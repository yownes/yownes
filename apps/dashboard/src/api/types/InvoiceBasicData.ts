...
// ====================================================
// GraphQL fragment: InvoiceBasicData
// ====================================================

export interface InvoiceBasicData_charges_edges_node_paymentIntent {
...
export interface InvoiceBasicData_charges_edges_node_paymentMethod {
...
export interface InvoiceBasicData_charges_edges_node {
   ...
   */
  paymentIntent: InvoiceBasicData_charges_edges_node_paymentIntent | null;
  /**
   * PaymentMethod used in this charge.
   */
  paymentMethod: InvoiceBasicData_charges_edges_node_paymentMethod | null;
  /**
...
export interface InvoiceBasicData_charges_edges {
  __typename: "StripeChargeTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: InvoiceBasicData_charges_edges_node | null;
}

export interface InvoiceBasicData_charges {
  __typename: "StripeChargeTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (InvoiceBasicData_charges_edges | null)[];
}

export interface InvoiceBasicData_customer {
...
export interface InvoiceBasicData_invoiceitems_edges_node_price {
...
export interface InvoiceBasicData_invoiceitems_edges_node {
   ...
   */
  price: InvoiceBasicData_invoiceitems_edges_node_price | null;
  /**
...
export interface InvoiceBasicData_invoiceitems_edges {
  __typename: "StripeInvoiceItemTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: InvoiceBasicData_invoiceitems_edges_node | null;
}

export interface InvoiceBasicData_invoiceitems {
  __typename: "StripeInvoiceItemTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (InvoiceBasicData_invoiceitems_edges | null)[];
}

export interface InvoiceBasicData_paymentIntent_paymentMethod {
  __typename: "StripePaymentMethodType";
  /**
   * The ID of the object.
   */
...
export interface InvoiceBasicData_paymentIntent {
  __typename: "StripePaymentIntentType";
  /**
   * The ID of the object.
   */
   ...
   */
  paymentMethod: InvoiceBasicData_paymentIntent_paymentMethod | null;
}

export interface InvoiceBasicData_subscription_plan_product {
...
export interface InvoiceBasicData_subscription_plan {
  __typename: "StripePlanType";
  /**
   * The product whose pricing this plan determines.
   */
  product: InvoiceBasicData_subscription_plan_product | null;
}

export interface InvoiceBasicData_subscription {
   ...
   */
  plan: InvoiceBasicData_subscription_plan | null;
  /**
...
export interface InvoiceBasicData {
   ...
   */
  charges: InvoiceBasicData_charges;
  /**
   * The datetime this object was created in stripe.
   */
  created: any | null;
   ...
   */
  customer: InvoiceBasicData_customer;
  /**
   ...
   */
  invoiceitems: InvoiceBasicData_invoiceitems;
  /**
   ...
   */
  paymentIntent: InvoiceBasicData_paymentIntent | null;
  /**
   ...
   */
  subscription: InvoiceBasicData_subscription | null;
  /**
