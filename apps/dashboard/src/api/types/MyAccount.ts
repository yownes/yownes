...
export interface MyAccount_me_subscription_invoices_edges_node_charges_edges_node_paymentMethod {
...
export interface MyAccount_me_subscription_invoices_edges_node_charges_edges_node {
   ...
   */
  paymentIntent: MyAccount_me_subscription_invoices_edges_node_charges_edges_node_paymentIntent | null;
  /**
   * PaymentMethod used in this charge.
   */
  paymentMethod: MyAccount_me_subscription_invoices_edges_node_charges_edges_node_paymentMethod | null;
  /**
...
export interface MyAccount_me_subscription_invoices_edges_node_charges_edges {
  __typename: "StripeChargeTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: MyAccount_me_subscription_invoices_edges_node_charges_edges_node | null;
}

export interface MyAccount_me_subscription_invoices_edges_node_charges {
  __typename: "StripeChargeTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (MyAccount_me_subscription_invoices_edges_node_charges_edges | null)[];
}

export interface MyAccount_me_subscription_invoices_edges_node_customer {
  __typename: "StripeCustomerType";
  /**
   * The ID of the object.
   */
...
export interface MyAccount_me_subscription_invoices_edges_node_invoiceitems_edges_node_price {
...
export interface MyAccount_me_subscription_invoices_edges_node_invoiceitems_edges_node {
   ...
   */
  price: MyAccount_me_subscription_invoices_edges_node_invoiceitems_edges_node_price | null;
  /**
...
export interface MyAccount_me_subscription_invoices_edges_node_invoiceitems_edges {
  __typename: "StripeInvoiceItemTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: MyAccount_me_subscription_invoices_edges_node_invoiceitems_edges_node | null;
}

export interface MyAccount_me_subscription_invoices_edges_node_invoiceitems {
  __typename: "StripeInvoiceItemTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (MyAccount_me_subscription_invoices_edges_node_invoiceitems_edges | null)[];
}

export interface MyAccount_me_subscription_invoices_edges_node_paymentIntent_paymentMethod {
  __typename: "StripePaymentMethodType";
  /**
   * The ID of the object.
   */
...
export interface MyAccount_me_subscription_invoices_edges_node {
   ...
   */
  charges: MyAccount_me_subscription_invoices_edges_node_charges;
  /**
   * The datetime this object was created in stripe.
   */
  created: any | null;
   ...
   */
  customer: MyAccount_me_subscription_invoices_edges_node_customer;
  /**
   ...
   */
  invoiceitems: MyAccount_me_subscription_invoices_edges_node_invoiceitems;
  /**
   ...
   */
  paymentIntent: MyAccount_me_subscription_invoices_edges_node_paymentIntent | null;
  /**
   ...
   */
  subscription: MyAccount_me_subscription_invoices_edges_node_subscription | null;
  /**
...
export interface MyAccount_me_subscription_invoices_edges {
   ...
   * The item at the end of the edge
   */
  node: MyAccount_me_subscription_invoices_edges_node | null;
}

export interface MyAccount_me_subscription_invoices {
  __typename: "StripeInvoiceTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (MyAccount_me_subscription_invoices_edges | null)[];
}

export interface MyAccount_me_subscription_plan_product_features_edges_node {
...
export interface MyAccount_me_subscription_plan_product_features_edges {
  __typename: "FeaturesTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: MyAccount_me_subscription_plan_product_features_edges_node | null;
}

export interface MyAccount_me_subscription_plan_product_features {
  __typename: "FeaturesTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (MyAccount_me_subscription_plan_product_features_edges | null)[];
}

export interface MyAccount_me_subscription_plan_product_prices_edges_node {
  __typename: "StripePriceType";
  /**
   * The ID of the object.
   */
...
export interface MyAccount_me_subscription_plan_product_prices_edges {
  __typename: "StripePriceTypeEdge";
  /**
   * The item at the end of the edge
   */
  node: MyAccount_me_subscription_plan_product_prices_edges_node | null;
}

export interface MyAccount_me_subscription_plan_product_prices {
  __typename: "StripePriceTypeConnection";
  /**
   * Contains the nodes in this connection.
   */
  edges: (MyAccount_me_subscription_plan_product_prices_edges | null)[];
}
...
export interface MyAccount_me_subscription_plan_product {
   ...
   */
  description: string | null;
  features: MyAccount_me_subscription_plan_product_features;
  /**
   * A set of key/value pairs that you can attach to an object. It can be useful for storing additional information about an object in a structured format.
   */
  metadata: string | null;
   ...
   */
  prices: MyAccount_me_subscription_plan_product_prices;
}
...
export interface MyAccount_me_subscription {
   ...
   */
  customer: MyAccount_me_subscription_customer;
  /**
   ...
   * The subscription that this invoice was prepared for, if any.
   */
  invoices: MyAccount_me_subscription_invoices;
  stripeId: string | null;
  /**
   * The status of this subscription.
   */
