...
export interface AccountBasicData_customer {
...
export interface AccountBasicData_subscription_invoices_edges_node_subscription_plan_product {
...
export interface AccountBasicData_subscription_invoices_edges_node_subscription_plan {
  __typename: "StripePlanType";
  /**
   * The product whose pricing this plan determines.
   */
  product: AccountBasicData_subscription_invoices_edges_node_subscription_plan_product | null;
}
...
export interface AccountBasicData_subscription_invoices_edges_node_subscription {
   ...
   */
  plan: AccountBasicData_subscription_invoices_edges_node_subscription_plan | null;
  /**
...
export interface AccountBasicData {
   ...
   */
  customer: AccountBasicData_customer | null;
  /**
